...
//La siguiente ruta nos permitira obtener una tarea_Calendario por su id unico
router.get('/api/calendary/:id', GetCalendaryById)

//La siguiente ruta nos permitira Eliminar una tarea_Calendario unico
router.delete('/api/calendary/:id', DeleteUniqueCalendary)

//Esta ruta nos permitira actualizar una tarea_Calendario, por medio de su id y enviando los datos con json
router.put('/api/calendary/:id', updateUniqueCalendary)


//Esta es una ruta de prueba para poder crear una tarea_Calendario desde el navegador
