  ...
  return (
    <KeyboardAvoidingWrapper>
      <StyledContainer>
        ...
        <InnerContainer>
          <PageLogo resizeMode="cover" source={require('./../assets/img/logo-gtd.png')} />
          <PageTitle>Getting Things Done</PageTitle>
          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              if (values.email == '' || values.password == '') {
                handleMessage('Por favor, llena todos los datos');
                setSubmitting(false);
              } else {
          ...
          >
            {({ handleChange, handleBlur, handleSubmit, values, isSubmitting }) => (
              <StyledFormArea>
                <MyTextInput
                  label="Email -> admin@gtd.com"
                  placeholder="admin@gtd.com"
